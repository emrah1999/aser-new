...
<table style="width: 600px;  border-top: 6px solid #ffce00; margin: auto;" >
    ...
    <tr>
        <td style=" padding: 55px 37px 48px 23px;  border-bottom: 3px solid #f0f0f0;">
            <p style="font-family: 'Kanit', sans-serif;  font-size: 16px; color: #20402e; line-height: 21px;   margin-bottom: 10px;">Уважаемый(ая) {{Auth::user()->name}} {{Auth::user()->surname}} , </p>
            <p style="font-family: 'Kanit', sans-serif;  font-size: 16px; color: #20402e; line-height: 21px;   margin-bottom: 10px;">
                Благодарим Вас за то, что выбрали Aser Cargo!
                Для завершения регистрации просим подтвердить Ваш электронный адрес, нажав расположенную ниже кнопку.
            </p>
            <a href="{{$actionUrl}}" style=" padding: 15px 55px;  background-color: #ffce00;    font-family: 'Kanit', sans-serif;  font-size: 12px;  color: #fff;  border-radius: 5px;   display: inline-block;    margin-top: 45px;  margin-bottom: 40px; text-decoration: none;"> Подтверждение </a>
            <br>
            <p style="font-family: 'Kanit', sans-serif;  font-size: 16px; color: #20402e; line-height: 21px;   margin-bottom: 10px;">
                Если есть проблема с кнопкой "Подтверждение", введите этот адрес: {{$actionUrl}}
            </p>
        </td>
    </tr>
    </tbody>
