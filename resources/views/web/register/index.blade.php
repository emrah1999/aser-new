    ...
    <div class="content" id="content">
        <section class="section section-registration d-flex justify-content-center align-items-center">
            <div class="container-lg">
                <form class="form form-registration center-block" name="formRegistrationPhysical"
                      id="formRegistrationPhysical" method="post"
                    ...
                    <div class="form-registration__btn-types d-flex justify-content-center align-items-center">
                        <div class="col">
                            <a href="{{route("register", ['locale' => App::getLocale(), 'type' => 'physical'])}}"
                               class="btn btn-trns-yellow btn-block btn-trns-yellow--active form-registration__btn-type form-registration__btn-type--pos-rel-right font-n-b">{!! __('static.physic') !!}</a>
                        </div>
                        <div class="col">
                            <a href="{{route("register", ['locale' => App::getLocale(), 'type' => 'juridical'])}}"
                               class="btn btn-trns-yellow btn-block form-registration__btn-type font-n-b">{!! __('static.jurdical') !!}</a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form__group">
                                    ...
                                    <input class="form__input" name="name" type="text" id="userName"
                                           placeholder="{!! __('static.namePH') !!}" value="{{ old('name') }}" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form__group">
                                    ...
                                    <input class="form__input" name="surname" value="{{ old('surname')}}" type="text"
                                           id="userSurname" placeholder="{!! __('static.surnamePH') !!}" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                                ...
                                <div class="form__group">
                                    ...
                                    <div class="form__select-wrapper">
                                        <select class="form__select" name="language" id="language" required>
                                            <option value="AZ" {{ old('language') == 'AZ' ? 'selected' : '' }}>AZ
                                            </option>
                            ...
                            <div class="col-sm-6">
                                <div class="form__group">
                                    ...
                                    <input class="form__input" name="parent_code" value="{{ old('parent_code')}}"
                                           type="text" id="userRefer">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-registration__content form-registration__content--2 {{ $showSecondPart ? '' : 'd-none' }}">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form__group">
                                    <label class="form__label"
                                           for="userPassportSeria">{!! __('auth.PassportSeries') !!}</label>
                                    <div class="form__select-wrapper">
                                        <select class="form__select" name="passport_series" id="userPassportSeria"
                                                required>
                                            <option value="0"
                                                    disabled {{ old('passport_series') ? '' : 'selected' }}>{!! __('static.choose') !!}</option>
                                            ...
                                            <option value="MYI" {{ old('passport_series') == 'MYI' ? 'selected' : '' }}>
                                                MYI
                                            </option>
                                            <option value="DYI" {{ old('passport_series') == 'DYI' ? 'selected' : '' }}>
                                                DYI
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form__group">
                                    <label class="form__label"
                                           for="userPassportSeriaNumber">{!! __('auth.PassportNumber') !!}</label>
                            ...
                            <div class="col-sm-6">
                                <div class="form__group">
                                    <label class="form__label"
                                           for="userPassportFinCode">{!! __('auth.PassportFIN') !!}</label>
                            ...
                            <div class="col-sm-6">
                                <div class="form__group">
                                    ...
                                    <input class="form__input" name="address1" value="{{ old('address1')}}" type="text"
                                           id="userAddress" placeholder="{!! __('static.addressPhReg') !!}" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form__group">
                                    ...
                                    <div class="input-container" style="position: relative;">
                                        <input class="form__input" name="password" value="{{ old('password')}}"
                                               type="password" id="userPassword"
                                               placeholder="{!! __('static.passwordReg') !!}" required
                            ...
                            <div class="col-sm-6">
                                <div class="form__group">
                                    <label class="form__label"
                                           for="userPassword2">{!! __('static.confirmPasswordReg2') !!}</label>
                                    <div class="input-container" style="position: relative;">
                                        <input class="form__input" name="user_password2"
                                               value="{{ old('user_password2')}}" type="password" id="userPassword2"
                                               placeholder="{!! __('static.confirmPasswordReg') !!}" required
                                               style="padding-right: 30px;">
                    ...
                    <div class="form-registration__btn-actions form-registration__btn-actions--1 {{ $showSecondPart ?  'd-none': '' }}">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-sm-6">
                                <div class="form__group">
                                    <label style="width: 200%;" class="form-checkbox d-flex justify-content-start align-items-center"
                                           for="userAgree">
                            ...
                            <div class="col-sm-6">
                                <button class="btn btn-yellow btn-block form__btn form-registration__btn-action form-registration__btn-action--next font-n-b"
                    ...
                    <div class="form-registration__btn-actions form-registration__btn-actions--2 {{ $showSecondPart ? '' : 'd-none' }}">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-sm-6">
                                <button class="btn btn-black btn-block form__btn form-registration__btn-action form-registration__btn-action--prev font-n-b"
                                        type="button">{!! __('static.backReg') !!}</button>
                            </div>
                            <div class="col-sm-6">
                                <button class="btn btn-yellow btn-block form__btn form-registration__btn-action form-registration__btn-action--submit font-n-b"
                                        name="formRegistrationPhysicalSubmit"
                                        type="submit">{!! __('static.register') !!}</button>
                            </div>
                        </div>
                    </div>
                    <div class="login-registration-question">
                        <p class="login-registration-question__block text-center">
                            ...
                            <a href="{{route("login", ['locale' => App::getLocale()])}}"
                               class="login-registration-question__link font-n-b">{!! __('static.login') !!}</a>
                        </p>
                    </div>
                </form>
            </div>
