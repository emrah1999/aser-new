...
function new_special_product (e, number) {
  ...
  let new_order = '<div class="sp-product-block mt-3"  id="product_block_' + new_number + '">'
  ...
  new_order += '</div>'
  new_order += '<div class="seperate_block col-12 row">'
  new_order += '<div class="col-md-4 col-xs-12 col-lg-1 n-margin">'
  new_order += '<div class="input_custom input-effect">'
  ...
  new_order += '</div>'
  new_order += '</div>'
  new_order += '<div class="col-md-4 col-xs-12 col-lg-3 n-margin">'
  new_order += '<div class="input_custom input-effect">'
  ...
  new_order += '</div>'
  new_order += '</div>'
  new_order += '<div class="col-md-6 col-xs-12 col-lg-5 n-margin d-flex">'
  ...
  new_order += '<div class="sp-product-control btn btn-add btn-success" onclick="new_special_product(this, ' + new_number + ');" data-title="Məhsulu sil">'
  new_order +=' <i class="fa fa-plus"></i>'
  new_order += '</div>'
  new_order += '</div>'
  new_order += '</div>'
